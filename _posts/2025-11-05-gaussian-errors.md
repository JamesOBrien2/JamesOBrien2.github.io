...
This tutorial aims to provide more specific help for typical Gaussian16 Errors that I've come across throughout my studies. Should you need any further help, below are some resources which provide general information on dealing with Gaussian Errors.
...
1. If this occurs at the start of the optimisation; ensure you have the correct keywords at the bottom of your file, and only integers. A combination of these mistakes will result in this error, instead of the anticipated _Modredundant_ error.
...
3. Use alternative algorith such as `IRC=LQA` or `IRC=DVV`
...
_Iteratively solves the SCF equations (conven. UHF & ROHF, all direct methods, SCRF)_
...
_Quadratically convergent SCF program_
