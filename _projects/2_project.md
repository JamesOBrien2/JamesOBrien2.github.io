...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/projects/cris_london_presentation.png" title="Example of halogen bonded complexes visualised using Blender" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
